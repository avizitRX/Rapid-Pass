...
class Blacklisted extends StatefulWidget {
  const Blacklisted({super.key});

  @override
  State<Blacklisted> createState() => _BlacklistedState();
}

class _BlacklistedState extends State<Blacklisted> {
...
৫) NFC চেক করার চেষ্টা''',
                ...
                RichText(
                  ...
                  text: TextSpan(
                    text: '''
এটি একটি NFC Technology’র অফলাইন স্টোর ভ্যালুড কার্ড। কার্ডের যাবতীয় তথ্য কার্ডের ভেতরের চিপে সংরক্ষিত থাকে এবং ব্যবহারের সময় অথোরাইজড ডিভাইসের মাধ্যমে এতে ডাটা রিড/রাইট হয়। সুতরাং, আন-অথোরাইজড কোনো NFC Device এর মাধ্যমে MRT/Rapid Pass ক্লোন/রিড/রাইট করার চেষ্টা করলে কার্ডটি বাতিল / ব্ল্যাকলিস্টেড হতে পারে।''',
                    style: Theme.of(context).textTheme.bodyLarge,
                  ),
                ),
                const SizedBox(
